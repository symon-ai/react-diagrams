(function webpackUniversalModuleDefinition(root, factory) {
	...
	else root["storm-react-diagrams"] = factory(root["_"], root["React"]);
})(
	window,
		...
		return (function (modules) {
				...
				function smoothenPath(grid, path) {
					...
					for (i = 2; i < len; ++i) {
						...
						for (j = 1; j < line.length; ++j) {
							testCoord = line[j];
							if (
								!grid.isWalkableAt(testCoord[0], testCoord[1])
							) {
								blocked = true;
								break;
							}
			...
			function (module, exports, __webpack_require__) {
				...
				var PointModel = (function (_super) {
					...
					PointModel.prototype.getSelectedEntities = function () {
						if (
							_super.prototype.isSelected.call(this) &&
					...
					PointModel.prototype.isLocked = function () {
						return (
							_super.prototype.isLocked.call(this) ||
							this.getParent().isLocked()
						);
					};
					return PointModel;
			...
			function (module, exports, __webpack_require__) {
				...
				var Toolkit = (function () {
					...
					Toolkit.generateLinePath = function (
						firstPoint,
						lastPoint
					) {
						return (
					...
					Toolkit.generateCurvePath = function (
						firstPoint,
						lastPoint,
						curvy
					) {
					...
					Toolkit.generateDynamicPath = function (pathCoords) {
						...
						pathCoords.slice(1).forEach(function (coords) {
							path = path.lineto(
								coords[0] *
									PathFinding_1.ROUTING_SCALING_FACTOR,
								coords[1] * PathFinding_1.ROUTING_SCALING_FACTOR
							);
						});
						return path.print();
					};
			...
			function (module, exports, __webpack_require__) {
				...
				var NodeModel = (function (_super) {
					...
					NodeModel.prototype.getSelectedEntities = function () {
						var entities = _super.prototype.getSelectedEntities.call(
							this
						);
						if (this.isSelected()) {
							_.forEach(this.ports, function (port) {
					...
					NodeModel.prototype.doClone = function (
						lookupTable,
						clone
					) {
			...
			function (module, exports, __webpack_require__) {
				...
				var PortModel = (function (_super) {
					...
					PortModel.prototype.doClone = function (
						lookupTable,
						clone
					) {
						if (lookupTable === void 0) {
					...
					PortModel.prototype.setMaximumLinks = function (
						maximumLinks
					) {
			...
			function (module, exports, __webpack_require__) {
				...
				var BaseEntity = (function () {
					...
					BaseEntity.prototype.doClone = function (
						lookupTable,
						clone
					) {
						if (lookupTable === void 0) {
					...
					BaseEntity.prototype.setLocked = function (locked) {
						...
						this.iterateListeners(function (listener, event) {
							if (listener.lockChanged) {
								listener.lockChanged(
									__assign({}, event, { locked: locked })
								);
							}
						});
					};
			...
			function (module, exports, __webpack_require__) {
				...
				JumpPointFinderBase.prototype.findPath = function (
					...
					var openList = (this.openList = new Heap(function (
							nodeA,
							nodeB
						) {
							return nodeA.f - nodeB.f;
						})),
						startNode = (this.startNode = grid.getNodeAt(
							startX,
							startY
						)),
				...
				JumpPointFinderBase.prototype._identifySuccessors = function (
					node
				) {
					var grid = this.grid,
			...
			function (module, exports, __webpack_require__) {
				...
				var PathFinding = (function () {
					...
					PathFinding.prototype.calculateDirectPath = function (
						from,
						to
					) {
						...
						return pathFinderInstance.findPath(
							this.diagramEngine.translateRoutingX(
								Math.floor(
									from.x / exports.ROUTING_SCALING_FACTOR
								)
							),
							this.diagramEngine.translateRoutingY(
								Math.floor(
									from.y / exports.ROUTING_SCALING_FACTOR
								)
							),
							this.diagramEngine.translateRoutingX(
								Math.floor(
									to.x / exports.ROUTING_SCALING_FACTOR
								)
							),
							this.diagramEngine.translateRoutingY(
								Math.floor(
									to.y / exports.ROUTING_SCALING_FACTOR
								)
							),
							grid
						);
					};
					PathFinding.prototype.calculateLinkStartEndCoords = function (
						matrix,
						path
					) {
					...
					PathFinding.prototype.calculateDynamicPath = function (
						routingMatrix,
						start,
						end,
						pathToStart,
						...
						var dynamicPath = pathFinderInstance.findPath(
							start.x,
							start.y,
							end.x,
							end.y,
						...
						var pathCoords = pathToStart
							...
							.map(function (coords) {
								return [
									_this.diagramEngine.translateRoutingX(
										coords[0],
										true
									),
									_this.diagramEngine.translateRoutingY(
										coords[1],
										true
									),
								];
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultLinkModel = (function (_super) {
					...
					DefaultLinkModel.prototype.deSerialize = function (
						ob,
						engine
					) {
						_super.prototype.deSerialize.call(this, ob, engine);
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultPortModel = (function (_super) {
					...
					function DefaultPortModel(isInput, name, label, id) {
						...
						var _this =
							_super.call(this, name, "default", id) || this;
						_this.in = isInput;
						_this.label = label || name;
						return _this;
					}
					DefaultPortModel.prototype.deSerialize = function (
						object,
						engine
					) {
					...
					DefaultPortModel.prototype.createLinkModel = function () {
						...
						return (
							link || new DefaultLinkModel_1.DefaultLinkModel()
						);
					};
			...
			function (module, exports, __webpack_require__) {
				...
				var LinkModel = (function (_super) {
					...
					LinkModel.prototype.doClone = function (
						lookupTable,
						clone
					) {
						if (lookupTable === void 0) {
						...
						if (this.sourcePort) {
							clone.setSourcePort(
								this.sourcePort.clone(lookupTable)
							);
						}
						if (this.targetPort) {
							clone.setTargetPort(
								this.targetPort.clone(lookupTable)
							);
						}
					};
					...
					LinkModel.prototype.setSourcePort = function (port) {
						...
						this.iterateListeners(function (listener, event) {
							if (listener.sourcePortChanged) {
								listener.sourcePortChanged(
									__assign({}, event, { port: port })
								);
							}
						});
					};
					...
					LinkModel.prototype.removePointsBefore = function (
						pointModel
					) {
						this.points.splice(0, this.getPointIndex(pointModel));
					};
					LinkModel.prototype.removePointsAfter = function (
						pointModel
					) {
						this.points.splice(this.getPointIndex(pointModel) + 1);
					};
					...
					LinkModel.prototype.addPoint = function (
						pointModel,
						index
					) {
						if (index === void 0) {
						...
						for (i = 0, l = neighbors.length; i < l; ++i) {
							...
							if (!neighbor.opened || ng < neighbor.g) {
								...
								neighbor.h =
									neighbor.h ||
									weight *
										heuristic(abs(x - endX), abs(y - endY));
			...
			function (module, exports, __webpack_require__) {
				...
				var NodeWidget = (function (_super) {
					...
					function NodeWidget(props) {
						var _this =
							_super.call(this, "srd-node", props) || this;
						_this.state = {};
						return _this;
					}
					NodeWidget.prototype.shouldComponentUpdate = function (
						...
						return this.props.diagramEngine.canEntityRepaint(
							this.props.node
						);
					};
					NodeWidget.prototype.componentDidUpdate = function () {
						var node = this.props.node;
						if (node.draw) {
							node.stopDraw();
						}
					...
					NodeWidget.prototype.getClassName = function () {
						return (
							"node " +
							_super.prototype.getClassName.call(this) +
				...
				var NodeLayerWidget = (function (_super) {
							...
							if (!_this.props.diagramEngine.nodesRendered) {
								...
								_.map(diagramModel.getNodes(), function (node) {
									node.updateDimensions(
										_this.props.diagramEngine.getNodeDimensions(
											node
										)
									);
								});
					...
					NodeLayerWidget.prototype.render = function () {
						...
						return React.createElement(
							...
							React.createElement(
								NodeLayerWidgetInner_1.NodeLayerWidgetInner,
			...
			function (module, exports, __webpack_require__) {
				...
				var LinkWidget = (function (_super) {
					...
					function LinkWidget(props) {
						var _this =
							_super.call(this, "srd-link", props) || this;
						_this.state = {};
						return _this;
					}
				...
				var LinkLayerWidget = (function (_super) {
					...
					LinkLayerWidget.prototype.render = function () {
						...
						return React.createElement(
							...
							React.createElement(
								LinkLayerWidgetInner_1.LinkLayerWidgetInner,
								{
									diagramEngine: this.props.diagramEngine,
			...
			function (module, exports, __webpack_require__) {
				...
				var SelectingAction = (function (_super) {
					...
					SelectingAction.prototype.containsElement = function (
						x,
						y,
						diagramModel
					) {
						...
						return (
							x * z + diagramModel.getOffsetX() >
								dimensions.left &&
							x * z + diagramModel.getOffsetX() <
								dimensions.right &&
							y * z + diagramModel.getOffsetY() >
								dimensions.top &&
							y * z + diagramModel.getOffsetY() <
								dimensions.bottom
						);
			...
			function (module, exports, __webpack_require__) {
				...
				var MoveItemsAction = (function (_super) {
					...
					function MoveItemsAction(mouseX, mouseY, diagramEngine) {
						...
						var selectedItems = diagramEngine
							.getDiagramModel()
							.getSelectedItems();
						selectedItems = selectedItems.filter(function (item) {
							return !diagramEngine.isModelLocked(item);
						});
						_this.selectionModels = selectedItems.map(function (
							item
						) {
							return {
								model: item,
			...
			function (module, exports, __webpack_require__) {
				...
				var PortWidget = (function (_super) {
					...
					function PortWidget(props) {
						var _this =
							_super.call(this, "srd-port", props) || this;
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultPortLabel = (function (_super) {
					...
					function DefaultPortLabel(props) {
						return (
							_super.call(this, "srd-default-port", props) || this
						);
					}
					...
					DefaultPortLabel.prototype.render = function () {
						var port = React.createElement(
							PortWidget_1.PortWidget,
							{
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultNodeWidget = (function (_super) {
					...
					function DefaultNodeWidget(props) {
						var _this =
							_super.call(this, "srd-default-node", props) ||
							this;
						_this.state = {};
						return _this;
					}
					DefaultNodeWidget.prototype.generatePort = function (port) {
						return React.createElement(
							DefaultPortLabelWidget_1.DefaultPortLabel,
							{ model: port, key: port.id }
						);
					};
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultLinkWidget = (function (_super) {
					...
					function DefaultLinkWidget(props) {
						var _this =
							_super.call(this, "srd-default-link", props) ||
							this;
						_this.addPointToLink = function (event, index) {
							if (
								!event.shiftKey &&
								!_this.props.diagramEngine.isModelLocked(
									_this.props.link
								) &&
								_this.props.link.points.length - 1 <=
									_this.props.diagramEngine.getMaxNumberPointsPerLink()
							) {
								var point = new PointModel_1.PointModel(
									_this.props.link,
									_this.props.diagramEngine.getRelativeMousePoint(
										event
									)
								);
						...
						_this.calculateLabelPosition = function (label, index) {
							...
							var _a = _this.findPathAndRelativePositionToRenderLabel(
									index
								),
								path = _a.path,
							...
							var labelCoordinates = {
								...
								y:
									pathCentre.y -
									labelDimensions.height / 2 +
									label.offsetY,
							};
							_this.refLabels[label.id].setAttribute(
								"style",
								"transform: translate(" +
									labelCoordinates.x +
									"px, " +
						...
						if (props.diagramEngine.isSmartRoutingEnabled()) {
							_this.pathFinding = new PathFinding_1.default(
								_this.props.diagramEngine
							);
						}
						return _this;
					}
					...
					DefaultLinkWidget.prototype.generatePoint = function (
						pointIndex
					) {
						var _this = this;
						...
						return React.createElement(
							"g",
							{
								key:
									"point-" +
									this.props.link.points[pointIndex].id,
							},
							...
							React.createElement("circle", {
								...
								"data-id": this.props.link.points[pointIndex]
									.id,
					...
					DefaultLinkWidget.prototype.generateLink = function (
						path,
						extraProps,
						id
					) {
					...
					DefaultLinkWidget.prototype.render = function () {
						...
						if (this.isSmartRoutingApplicable()) {
							var directPathCoords = this.pathFinding.calculateDirectPath(
								_.first(points),
								_.last(points)
							);
							var routingMatrix = diagramEngine.getRoutingMatrix();
							var smartLink = this.pathFinding.calculateLinkStartEndCoords(
								routingMatrix,
								directPathCoords
							);
							if (smartLink) {
								...
								var simplifiedPath = this.pathFinding.calculateDynamicPath(
									routingMatrix,
									start,
									end,
									pathToStart,
								...
								paths.push(
									this.generateLink(
										Toolkit_1.Toolkit.generateDynamicPath(
											simplifiedPath
										),
										{
						...
						if (paths.length === 0) {
							if (points.length === 2) {
								...
								paths.push(
									this.generateLink(
										Toolkit_1.Toolkit.generateCurvePath(
											pointLeft,
											pointRight,
								...
								var _loop_1 = function (j) {
									paths.push(
										this_1.generateLink(
											Toolkit_1.Toolkit.generateLinePath(
												points[j],
												points[j + 1]
											),
											{
												"data-linkid":
													this_1.props.link.id,
												"data-point": j,
												onMouseDown: function (event) {
													_this.addPointToLink(
														event,
														j + 1
													);
												},
								...
								if (this.props.link.targetPort === null) {
									paths.push(
										this.generatePoint(points.length - 1)
									);
								}
							}
						}
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultNodeModel = (function (_super) {
					...
					DefaultNodeModel.prototype.addInPort = function (label) {
						return this.addPort(
							new DefaultPortModel_1.DefaultPortModel(
								true,
								Toolkit_1.Toolkit.UID(),
								label
							)
						);
					};
					...
					DefaultNodeModel.prototype.deSerialize = function (
						object,
						engine
					) {
						_super.prototype.deSerialize.call(this, object, engine);
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultLabelWidget = (function (_super) {
					...
					function DefaultLabelWidget(props) {
						return (
							_super.call(this, "srd-default-label", props) ||
							this
						);
					}
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultLabelFactory = (function (_super) {
					...
					DefaultLabelFactory.prototype.generateReactWidget = function (
						diagramEngine,
						label
					) {
						return React.createElement(
							DefaultLabelWidget_1.DefaultLabelWidget,
							{ model: label }
						);
					};
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultPortFactory = (function (_super) {
					...
					DefaultPortFactory.prototype.getNewInstance = function (
						initialConfig
					) {
			...
			function (module, exports, __webpack_require__) {
				...
				var DiagramModel = (function (_super) {
					...
					DiagramModel.prototype.deSerializeDiagram = function (
						object,
						diagramEngine
					) {
						var _this = this;
					...
					DiagramModel.prototype.getSelectedItems = function () {
						...
						if (filters.length > 0) {
							items = _.filter(_.uniq(items), function (item) {
								if (
									_.includes(filters, "node") &&
									item instanceof NodeModel_1.NodeModel
								) {
									return true;
								}
								if (
									_.includes(filters, "link") &&
									item instanceof LinkModel_1.LinkModel
								) {
									return true;
								}
								if (
									_.includes(filters, "port") &&
									item instanceof PortModel_1.PortModel
								) {
									return true;
								}
								if (
									_.includes(filters, "point") &&
									item instanceof PointModel_1.PointModel
								) {
									return true;
								}
								return false;
						...
						this.iterateListeners(function (listener, event) {
							if (listener.zoomUpdated) {
								listener.zoomUpdated(
									__assign({}, event, { zoom: zoom })
								);
							}
						});
					};
					DiagramModel.prototype.setIsCanvasMoving = function (
						value
					) {
					...
					DiagramModel.prototype.getIsCanvasMoving = function () {
			...
			function (module, exports, __webpack_require__) {
				...
				var _ = __webpack_require__(0);
				var NodeLayerWidgetInner = (function (_super) {
					__extends(NodeLayerWidgetInner, _super);
					function NodeLayerWidgetInner() {
						return (
							(_super !== null &&
								_super.apply(this, arguments)) ||
							this
					...
					NodeLayerWidgetInner.prototype.shouldComponentUpdate = function (
						nextProps
					) {
					...
					NodeLayerWidgetInner.prototype.render = function () {
						var _this = this;
						var diagramModel = this.props.diagramEngine.getDiagramModel();
						return React.createElement(
							React.Fragment,
							...
							_.map(diagramModel.getNodes(), function (node) {
								return React.createElement(
									...
									_this.props.diagramEngine.generateWidgetForNode(
										node
									)
								);
							})
					...
					return NodeLayerWidgetInner;
				})(React.Component);
				exports.NodeLayerWidgetInner = NodeLayerWidgetInner;
			},
			function (module, exports, __webpack_require__) {
				"use strict";
				var __extends =
				...
				var _ = __webpack_require__(0);
				var LinkLayerWidgetInner = (function (_super) {
					__extends(LinkLayerWidgetInner, _super);
					function LinkLayerWidgetInner() {
						return (
							(_super !== null &&
								_super.apply(this, arguments)) ||
							this
					...
					LinkLayerWidgetInner.prototype.shouldComponentUpdate = function (
						nextProps
					) {
						var modelNext = nextProps.diagramEngine.getDiagramModel();
						var isCanvasMoving = modelNext.getIsCanvasMoving();
					...
					LinkLayerWidgetInner.prototype.render = function () {
						var _this = this;
						var diagramModel = this.props.diagramEngine.getDiagramModel();
						return React.createElement(
							React.Fragment,
								...
								_.map(diagramModel.getLinks(), function (link) {
									if (
										...
										if (link.sourcePort !== null) {
											try {
												var portCenter = _this.props.diagramEngine.getPortCenter(
													link.sourcePort
												);
												link.points[0].updateLocation(
													portCenter
												);
												var portCoords = _this.props.diagramEngine.getPortCoords(
													link.sourcePort
												);
												link.sourcePort.updateCoords(
													portCoords
												);
												_this.props.diagramEngine.linksThatHaveInitiallyRendered[
													link.id
												] = true;
											} catch (ignore) {}
										}
									...
									var generatedLink = _this.props.diagramEngine.generateWidgetForLink(
										link
									);
									if (!generatedLink) {
										throw new Error(
											"no link generated for type: " +
												link.getType()
										);
									}
									return React.createElement(
					...
					return LinkLayerWidgetInner;
				})(React.Component);
				exports.LinkLayerWidgetInner = LinkLayerWidgetInner;
			},
			function (module, exports, __webpack_require__) {
				"use strict";
				var __extends =
				...
				var DiagramWidget = (function (_super) {
					...
					function DiagramWidget(props) {
						var _this =
							_super.call(this, "srd-diagram", props) || this;
					...
					DiagramWidget.prototype.componentWillReceiveProps = function (
						nextProps
					) {
						var _this = this;
						if (
							this.props.diagramEngine !== nextProps.diagramEngine
						) {
							this.props.diagramEngine.removeListener(
								this.state.diagramEngineListener
							);
					...
					DiagramWidget.prototype.componentWillUpdate = function (
						nextProps
					) {
						if (
					...
					DiagramWidget.prototype.getMouseElement = function (event) {
						...
						var diagramModel = this.props.diagramEngine
							.diagramModel;
						var element = Toolkit_1.Toolkit.closest(
							target,
							".port[data-name]"
						);
						if (element) {
							var nodeElement = Toolkit_1.Toolkit.closest(
								target,
								".node[data-nodeid]"
							);
							return {
						...
						element = Toolkit_1.Toolkit.closest(
							target,
							".point[data-id]"
						);
						if (element) {
					...
					DiagramWidget.prototype.stopFiringAction = function (
						shouldSkipEvent
					) {
						if (
					...
					DiagramWidget.prototype.startFiringAction = function (
						action
					) {
						var setState = true;
					...
					DiagramWidget.prototype.onMouseMove = function (event) {
						...
						if (
							this.state.action instanceof
							SelectingAction_1.SelectingAction
						) {
							...
							_.forEach(diagramModel.getNodes(), function (node) {
								if (
									_this.state.action.containsElement(
										node.x,
										node.y,
										diagramModel
									)
							...
							this.state.action instanceof
								MoveItemsAction_1.MoveItemsAction &&
							...
							_.forEach(
								...
								function (model) {
									if (
										...
										if (
											diagramEngine.isSmartRoutingEnabled()
										) {
							...
							this.state.action instanceof
							MoveCanvasAction_1.MoveCanvasAction
						) {
							if (this.props.allowCanvasTranslation) {
								diagramModel.setOffset(
									this.state.action.initialOffsetX +
										(event.clientX -
											this.state.action.mouseX),
									this.state.action.initialOffsetY +
										(event.clientY -
											this.state.action.mouseY)
								);
					...
					DiagramWidget.prototype.onKeyUp = function (event) {
						...
						if (
							this.props.deleteKeys.indexOf(event.keyCode) !== -1
						) {
							_.forEach(
								this.props.diagramEngine
									.getDiagramModel()
					...
					DiagramWidget.prototype.graphAlreadyHasLink = function (
						pointLink,
						diagramLinks,
						element
					) {
						var links = pointLink.sourcePort.getLinks();
						if (pointLink.sourcePort.in) {
					...
					DiagramWidget.prototype.shouldAddLink = function (
						pointLink,
						srcPort,
						tarPort
					) {
					...
					DiagramWidget.prototype.onMouseUp = function (event) {
						...
						if (
							...
							_.forEach(
								...
								function (model) {
									...
									var pointLink = model.model.getLink();
									var diagramLinks =
										diagramEngine.diagramModel.links;
									if (
										_this.state.action.selectionModels
											.length === 1 &&
										element &&
										element.model &&
										element.model.toolType
									) {
										var isData =
											pointLink.sourcePort.portType !==
											"model";
										var matchingPortId = void 0;
										if (pointLink.sourcePort.in) {
											var portKeys = Object.keys(
												element.model.ports
											);
											for (
												var c = 0;
											...
											if (matchingPortId) {
												...
												if (
													...
													nodeLink = model.model
														.getLink()
														.clone({});
													nodeLink.setSourcePort(
														matchPort
													);
													nodeLink.setTargetPort(
														pointLink.sourcePort
													);
													diagramEngine
														.getDiagramModel()
									...
									if (
										...
										if (
											(allModels &&
												allModels.length === 1) ||
											pointLink.getSourcePort() ===
												null ||
											pointLink.getTargetPort() === null
										) {
											pointLink.remove();
										} else if (
											pointLink.getSourcePort().in ===
											pointLink.getTargetPort().in
										) {
											pointLink.remove();
										}
										return;
									...
									if (pointLink.sourcePort) {
										var hasLinkAlready = _this.graphAlreadyHasLink(
											pointLink,
											diagramLinks,
											element
										);
									...
									if (
										element &&
										element.model instanceof
											PortModel_1.PortModel &&
										!diagramEngine.isModelLocked(
											element.model
										)
									) {
										...
										delete _this.props.diagramEngine
											.linksThatHaveInitiallyRendered[
											link.getID()
										];
									}
								...
								function (model) {
									...
									if (
										...
										if (sourcePort.in && !targetPort.in) {
											var forwardLink = link.clone({});
											forwardLink.setSourcePort(
												targetPort
											);
											forwardLink.setTargetPort(
												sourcePort
											);
											diagramEngine
												.getDiagramModel()
						...
						this.state.document.removeEventListener(
							"mousemove",
							this.onMouseMove
						);
						this.state.document.removeEventListener(
					...
					DiagramWidget.prototype.render = function () {
						...
						diagramEngine.setSmartRoutingStatus(
							this.props.smartRouting
						);
						var diagramModel = diagramEngine.getDiagramModel();
						return React.createElement(
							"div",
							__assign({}, this.getProps(), {
								ref: function (ref) {
									if (ref) {
										_this.props.diagramEngine.setCanvas(
											ref
										);
									}
								},
								...
								onMouseDown: function (event) {
									...
									if (model === null) {
										if (event.shiftKey) {
											...
											_this.startFiringAction(
												new SelectingAction_1.SelectingAction(
													relative.x,
													relative.y
												)
											);
											...
											_this.startFiringAction(
												new MoveCanvasAction_1.MoveCanvasAction(
													event.clientX,
													event.clientY,
													diagramModel
												)
										...
										if (
											...
											if (link) {
												...
												var moveAction = new MoveItemsAction_1.MoveItemsAction(
													event.clientX,
													event.clientY,
													diagramEngine
												);
												if (_this.props.onMoveStart) {
													_this.props.onMoveStart(
														moveAction
													);
												}
												_this.startFiringAction(
										...
										_this.startFiringAction(
											new MoveItemsAction_1.MoveItemsAction(
												event.clientX,
												event.clientY,
												diagramEngine
											)
									...
									_this.state.document.addEventListener(
										"mousemove",
										_this.onMouseMove
									);
									_this.state.document.addEventListener(
							...
							this.state.renderedNodes &&
								React.createElement(
									LinkLayerWidget_1.LinkLayerWidget,
									{
										...
										pointAdded: function (point, event) {
											...
											_this.setState({
												action: new MoveItemsAction_1.MoveItemsAction(
													event.clientX,
													event.clientY,
													diagramEngine
												),
							...
							React.createElement(
								NodeLayerWidget_1.NodeLayerWidget,
								{ diagramEngine: diagramEngine }
							),
							this.state.action instanceof
								SelectingAction_1.SelectingAction &&
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultNodeFactory = (function (_super) {
					...
					DefaultNodeFactory.prototype.generateReactWidget = function (
						diagramEngine,
						node
					) {
						return React.createElement(
							DefaultNodeWidget_1.DefaultNodeWidget,
							{ node: node, diagramEngine: diagramEngine }
						);
					};
					DefaultNodeFactory.prototype.getNewInstance = function (
						initialConfig
					) {
			...
			function (module, exports, __webpack_require__) {
				...
				var DefaultLinkFactory = (function (_super) {
					...
					DefaultLinkFactory.prototype.generateReactWidget = function (
						diagramEngine,
						link
					) {
						return React.createElement(
							DefaultLinkWidget_1.DefaultLinkWidget,
							{ link: link, diagramEngine: diagramEngine }
						);
					};
					...
					DefaultLinkFactory.prototype.generateLinkSegment = function (
						model,
						widget,
						selected,
						path
				...
				var DiagramEngine = (function (_super) {
					...
					function DiagramEngine() {
						...
						_this.calculateMatrixDimensions = function () {
							var allNodesCoords = _.values(
								_this.diagramModel.nodes
							).map(function (item) {
								return {
									x: item.x,
									width: item.width,
						...
						_this.markNodes = function (matrix) {
							_.values(_this.diagramModel.nodes).forEach(
								function (node) {
									...
									for (
										...
										for (
											...
											_this.markMatrixPoint(
												matrix,
												_this.translateRoutingX(x),
												_this.translateRoutingY(y)
											);
										}
									}
								}
						...
						_this.markPorts = function (matrix) {
							var allElements = _.flatMap(
								_.values(_this.diagramModel.links).map(
									function (link) {
										return [].concat(
											link.sourcePort,
											link.targetPort
					...
					DiagramEngine.prototype.installDefaultFactories = function () {
						this.registerNodeFactory(
							new main_1.DefaultNodeFactory()
						);
						this.registerLinkFactory(
							new main_1.DefaultLinkFactory()
						);
						this.registerPortFactory(
							new DefaultPortFactory_1.DefaultPortFactory()
						);
						this.registerLabelFactory(
							new DefaultLabelFactory_1.DefaultLabelFactory()
						);
					};
					...
					DiagramEngine.prototype.enableRepaintEntities = function (
						entities
					) {
						var _this = this;
					...
					DiagramEngine.prototype.canEntityRepaint = function (
						baseModel
					) {
						...
						return (
							this.paintableWidgets[baseModel.getID()] !==
							undefined
						);
					};
					...
					DiagramEngine.prototype.registerLabelFactory = function (
						factory
					) {
					...
					DiagramEngine.prototype.registerPortFactory = function (
						factory
					) {
					...
					DiagramEngine.prototype.registerNodeFactory = function (
						factory
					) {
					...
					DiagramEngine.prototype.registerLinkFactory = function (
						factory
					) {
					...
					DiagramEngine.prototype.getPortFactory = function (type) {
						...
						throw new Error(
							"cannot find factory for port of type: [" +
								type +
								"]"
						);
					};
					DiagramEngine.prototype.getNodeFactory = function (type) {
						...
						throw new Error(
							"cannot find factory for node of type: [" +
								type +
								"]"
						);
					};
					DiagramEngine.prototype.getLinkFactory = function (type) {
						...
						throw new Error(
							"cannot find factory for link of type: [" +
								type +
								"]"
						);
					};
					DiagramEngine.prototype.getLabelFactory = function (type) {
						...
						throw new Error(
							"cannot find factory for label of type: [" +
								type +
								"]"
						);
					};
					DiagramEngine.prototype.getFactoryForNode = function (
						node
					) {
						return this.getNodeFactory(node.getType());
					};
					DiagramEngine.prototype.getFactoryForLink = function (
						link
					) {
						return this.getLinkFactory(link.getType());
					};
					DiagramEngine.prototype.getFactoryForLabel = function (
						label
					) {
						return this.getLabelFactory(label.getType());
					};
					DiagramEngine.prototype.generateWidgetForLink = function (
						link
					) {
						var linkFactory = this.getFactoryForLink(link);
						if (!linkFactory) {
							throw new Error(
								"Cannot find link factory for link: " +
									link.getType()
							);
						}
						return linkFactory.generateReactWidget(this, link);
					};
					DiagramEngine.prototype.generateWidgetForNode = function (
						node
					) {
						var nodeFactory = this.getFactoryForNode(node);
						if (!nodeFactory) {
							throw new Error(
								"Cannot find widget factory for node: " +
									node.getType()
							);
						}
						return nodeFactory.generateReactWidget(this, node);
					};
					DiagramEngine.prototype.getRelativeMousePoint = function (
						event
					) {
						var point = this.getRelativePoint(
							event.clientX,
							event.clientY
						);
						return {
							x:
								...
								(this.diagramModel.getZoomLevel() / 100),
							y:
					...
					DiagramEngine.prototype.getNodePortElement = function (
						port
					) {
						var selector = this.canvas.querySelector(
							'.port[data-name="' +
					...
					DiagramEngine.prototype.getNodeDimensions = function (
						node
					) {
						if (!this.canvas) {
					...
					DiagramEngine.prototype.setMaxNumberPointsPerLink = function (
						max
					) {
					...
					DiagramEngine.prototype.setSmartRoutingStatus = function (
						status
					) {
					...
					DiagramEngine.prototype.calculateCanvasMatrix = function () {
						...
						var matrixWidth = Math.ceil(
							canvasWidth / PathFinding_1.ROUTING_SCALING_FACTOR
						);
						var matrixHeight = Math.ceil(
							canvasHeight / PathFinding_1.ROUTING_SCALING_FACTOR
						);
					...
					DiagramEngine.prototype.translateRoutingX = function (
						x,
						reverse
					) {
						if (reverse === void 0) {
					...
					DiagramEngine.prototype.translateRoutingY = function (
						y,
						reverse
					) {
						if (reverse === void 0) {
					...
					DiagramEngine.prototype.zoomToFit = function () {
						var xFactor =
							this.canvas.clientWidth / this.canvas.scrollWidth;
						var yFactor =
							this.canvas.clientHeight / this.canvas.scrollHeight;
			...
			function (module, exports, __webpack_require__) {
				...
				var doHalflinesCross = function doHalflinesCross(sa, sb) {
					...
					if (sa.m == Infinity)
						return (
							sa.hp * (sb.m * dx - dy) <= approx &&
							sb.vec[0] * dx <= approx
						);
					if (sb.m == Infinity)
						return (
							sb.hp * (sa.m * dx - dy) >= -approx &&
							sa.vec[0] * dx >= -approx
						);
				...
				var transformEllipse = function transformEllipse(
					rx,
					ry,
					ax,
					m
					...
					return {
						...
						ax: newAx,
						isDegenerate:
							newRx < epsilon * newRy || newRy < epsilon * newRx,
					};
				};
				exports["default"] = {
			...
			function (module, exports, __webpack_require__) {
				...
				var _geom = __webpack_require__(52);
				var Path = function Path(init) {
					...
					var transformParams = function transformParams(
						instruction,
						matrix,
						prev
					) {
						...
						var transformer = {
							V: function V(instruction, matrix, prev) {
								...
								var newPts = (0, _geom.matrixTransform)(
									pts,
									matrix
								);
								if (
									newPts[0].x ===
									(0, _geom.matrixTransform)([
										{ x: prev[0], y: prev[1] },
									])[0].x
								) {
									return {
							...
							A: function A(instruction, matrix, prev) {
								var r = (0, _geom.transformEllipse)(
									p[0],
									p[1],
									p[2],
									matrix
							...
							default: function _default(
								...
								var newParams = instruction.params.slice(
									0,
						...
						if (transformer[instruction.command]) {
							return transformer[instruction.command](
								instruction,
								matrix,
								prev
							);
					...
					return {
						...
						translate: verbosify(["dx", "dy"], function () {
							...
							if (dx !== 0 || dx !== 0) {
								var _ret = (function () {
									...
									var newInstructions = _instructions.map(
								...
								if (angle !== 0) {
									var _ret2 = (function () {
										...
										if (rx !== 0 && ry !== 0) {
											...
											newInstructions = newInstructions.map(
												function (instruction) {
													var p = transformParams(
														instruction,
														matrix,
						...
						connect: function connect(path) {
							...
							if (
								_instructions[_instructions.length - 1]
									.command !== "Z"
							) {
			...
			function (module, exports, __webpack_require__) {
				...
				JPFMoveDiagonallyIfAtMostOneObstacle.prototype._jump = function (
					...
					if (dx !== 0 && dy !== 0) {
						...
						if (
							this._jump(x + dx, y, x, y) ||
							this._jump(x, y + dy, x, y)
						) {
							return [x, y];
						}
					} else {
					...
					if (parent) {
						...
						if (dx !== 0 && dy !== 0) {
							...
							if (dx !== 0) {
								...
								var isBottomWalkable = grid.isWalkableAt(
									x,
									y - 1
								);
								if (isNextWalkable) {
								...
								var isRightWalkable = grid.isWalkableAt(
									x + 1,
									y
								);
								var isLeftWalkable = grid.isWalkableAt(
									x - 1,
									y
								);
								if (isNextWalkable) {
			...
			function (module, exports, __webpack_require__) {
				...
				JPFAlwaysMoveDiagonally.prototype._jump = function (
					x,
					y,
					px,
					py
				...
				JPFAlwaysMoveDiagonally.prototype._findNeighbors = function (
					node
				) {
					var parent = node.parent,
						x = node.x,
			...
			function (module, exports, __webpack_require__) {
				...
				JPFNeverMoveDiagonally.prototype._jump = function (
					x,
					y,
					px,
					py
				...
				JPFNeverMoveDiagonally.prototype._findNeighbors = function (
					node
				) {
					var parent = node.parent,
						x = node.x,
			...
			function (module, exports, __webpack_require__) {
				var DiagonalMovement = __webpack_require__(2);
				var JPFNeverMoveDiagonally = __webpack_require__(57);
				var JPFAlwaysMoveDiagonally = __webpack_require__(56);
				var JPFMoveDiagonallyIfNoObstacles = __webpack_require__(55);
				var JPFMoveDiagonallyIfAtMostOneObstacle = __webpack_require__(
					54
				);
				function JumpPointFinder(opt) {
					...
					if (opt.diagonalMovement === DiagonalMovement.Never) {
						...
						opt.diagonalMovement === DiagonalMovement.Always
					) {
						return new JPFAlwaysMoveDiagonally(opt);
					} else if (
						opt.diagonalMovement ===
						DiagonalMovement.OnlyWhenNoObstacles
					) {
			...
			function (module, exports, __webpack_require__) {
				...
				IDAStarFinder.prototype.findPath = function (
					...
					var search = function (node, g, cutoff, route, depth) {
						...
						var neighbours = grid.getNeighbors(
							node,
							this.diagonalMovement
						);
						for (
			...
			function (module, exports, __webpack_require__) {
				...
				Grid.prototype.getNeighbors = function (
					node,
					diagonalMovement
				) {
					var x = node.x,
			...
			function (module, exports, __webpack_require__) {
				(function (module) {
					(function () {
						...
						insort = function (a, x, lo, hi, cmp) {
							...
							return (
								[].splice.apply(a, [lo, lo - lo].concat(x)), x
							);
						};
				...
				}.call(this, __webpack_require__(67)(module)));
			},
			function (module, exports, __webpack_require__) {
				module.exports = {
					...
					BestFirstFinder: __webpack_require__(65),
					BreadthFirstFinder: __webpack_require__(64),
					DijkstraFinder: __webpack_require__(63),
					BiAStarFinder: __webpack_require__(22),
					BiBestFirstFinder: __webpack_require__(62),
					BiBreadthFirstFinder: __webpack_require__(61),
					BiDijkstraFinder: __webpack_require__(60),
					IDAStarFinder: __webpack_require__(59),
					JumpPointFinder: __webpack_require__(58),
				};
			},
			function (module, exports, __webpack_require__) {
			...
			function (module, exports, __webpack_require__) {
				var matches = __webpack_require__(71);
